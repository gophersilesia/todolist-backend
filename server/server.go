...
func RegisterHandlers() *httprouter.Router {
	...
	rt.MethodNotAllowed = cstMethodNotAllowed{}
	rt.NotFound = cstNotFound{}

	return rt
}

// cstMethodNotAllowed is a struct for handling custom "method not allowed" action
...
// cstNotFound is a struct for handling custom "method not allowed" action
type cstNotFound struct{}

// ServeHTTP is a handler for "not found" generated by router
func (wrt cstNotFound) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	handleSuccess(w, http.StatusNotFound, "Not found")
}
